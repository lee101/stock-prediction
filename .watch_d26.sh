...
DIR="pufferlib_market/checkpoints/stocks17_sweep/D_muon/s26"
VAL="pufferlib_market/data/stocks17_augmented_val.bin"
echo "[$(date -u +%FT%TZ)] Watching D s26..."
while ! [ -f "$DIR/final.pt" ]; do sleep 30; done
echo "[$(date -u +%FT%TZ)] D s26 done. Evaluating..."
...
echo "[$(date -u +%FT%TZ)] D s26 eval done."
