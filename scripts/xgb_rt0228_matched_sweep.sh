#!/usr/bin/env bash
# Matched sweep: XGB retrain-through-0228 on same heldout + grid as MuonMLP,
# for apples-to-apples H2H comparison.
set -euo pipefail
cd "$(dirname "$0")/.."
source .venv/bin/activate

OUT_DIR="analysis/xgbnew_daily/sweep_20260422_rt0228_xgb_matched"
mkdir -p "$OUT_DIR"
