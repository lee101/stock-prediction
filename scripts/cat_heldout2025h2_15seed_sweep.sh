#!/usr/bin/env bash
# 15-seed bonferroni sweep on CAT heldout2025h2 fold (train_end=2025-06-30,
# OOS 2025-07-01 → 2026-04-20). Matches XGB oos2025h1 grid for direct
...
OUT_DIR="analysis/xgbnew_daily/sweep_20260422_cat_heldout2025h2_15seed"
mkdir -p "$OUT_DIR"

MODELS=$(ls analysis/xgbnew_daily/heldout2025h2_cat/alltrain_seed*.pkl | paste -sd,)
