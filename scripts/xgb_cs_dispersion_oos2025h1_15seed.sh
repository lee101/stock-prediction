#!/usr/bin/env bash
# 15-seed bonferroni re-test of the cs-dispersion regime gate on fold 1
# (train 2020 → 2025-06-30, OOS 2025-07 → 2026-04-20).
set -euo pipefail
cd "$(dirname "$0")/.."
# shellcheck disable=SC1091
source .venv/bin/activate

OUT_DIR="analysis/xgbnew_daily/sweep_20260422_cs_dispersion_oos2025h1_15seed"
mkdir -p "$OUT_DIR"
