#!/usr/bin/env bash
# Train 10 extra seeds on fold 1 (oos2025h1_fresh) to form clean 15-seed
# ensemble for cs-dispersion gate bonferroni re-test.
set -euo pipefail
cd "$(dirname "$0")/.."
# shellcheck disable=SC1091
source .venv/bin/activate

OUT_DIR="analysis/xgbnew_daily/oos2025h1_ensemble_gpu_fresh"
mkdir -p "$OUT_DIR"
