...
Last synced: **2026-04-22 19:00 UTC — hourly monitor. Phase 1 GREEN (stable vs prior hour): XGB RUNNING (1d 20h uptime, pid=3315287 unchanged), singleton lock=xgb_live_trader matches pid, equity $28,678.98 flat, 0 stock pos, today's 2026-04-22 session top-1=LCID 0.5542 / 668 candidates (healthy R9b low-conv regime), RL path DOWN, disk 83% warn (both fs, below 85% R6 threshold), weekly retrain timer set for Sun 2026-04-26 23:00 UTC. Phase 3: re-confirmed deployed cell (lev=2.0 ms=0.85 ht=1 vol=0.12 dv=50M) in prior-hour's 98-cell leverage curve sweep: 0 trades / 42 windows / 0% DD = hold-cash; 0/98 cells overall pass 27%/mo+p10>0+0neg gate. No new sweep launched (trading window 13:30-20:00 UTC active; heavy training forbidden). No candidate. Pending: post-close architectural experiment — XGB-family fully exhausted on 15-seed bonferroni across all tested levers; pivot to Chronos-2 / PufferLib PPO / regime detector documented in project memory.**
