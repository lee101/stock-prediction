...
class CWorkStealConfig(Structure):
    _fields_ = [
        ...
        ("market_breadth_filter", c_double),
        ("risk_off_sma_period", c_int),
        ("risk_off_momentum_period", c_int),
        ("risk_off_momentum_threshold", c_double),
        ("risk_off_breadth_threshold", c_double),
        ("atr_period", c_int),
        ("atr_dip_mult", c_double),
    ]
...
def _config_to_c(config) -> CWorkStealConfig:
    return CWorkStealConfig(
        ...
        market_breadth_filter=getattr(config, 'market_breadth_filter', 0.0),
        risk_off_sma_period=getattr(config, 'risk_off_sma_period', 0),
        risk_off_momentum_period=getattr(config, 'risk_off_momentum_period', 0),
        risk_off_momentum_threshold=getattr(config, 'risk_off_momentum_threshold', -0.05),
        risk_off_breadth_threshold=getattr(config, 'risk_off_breadth_threshold', 0.0),
        atr_period=getattr(config, 'atr_period', 0),
        atr_dip_mult=getattr(config, 'atr_dip_mult', 0.0),
    )
