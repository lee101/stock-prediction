...
declare -a VARIANTS=(
  ...
  "seed_7|SEED=7 LEARNING_RATE=5e-5 BATCH_SIZE=512 N_STEPS=2048 GAMMA=0.995 GAE_LAMBDA=0.98 DRAWDOWN_PENALTY=0.05 CVAR_PENALTY=0.25 TURNOVER_PENALTY=0.001 REGIME_LEVERAGE_SCALE=0.35"
  "seed_99|SEED=99 LEARNING_RATE=5e-5 BATCH_SIZE=512 N_STEPS=2048 GAMMA=0.995 GAE_LAMBDA=0.98 DRAWDOWN_PENALTY=0.05 CVAR_PENALTY=0.25 TURNOVER_PENALTY=0.001 REGIME_LEVERAGE_SCALE=0.35"
  ...
  "cost_extreme|LEARNING_RATE=5e-5 BATCH_SIZE=512 N_STEPS=2048 GAMMA=0.995 GAE_LAMBDA=0.98 COSTS_BPS=12.0 DRAWDOWN_PENALTY=0.12 CVAR_PENALTY=0.50 TURNOVER_PENALTY=0.0040 REGIME_DRAWDOWN_THRESHOLD=0.02 REGIME_LEVERAGE_SCALE=0.20"
  "turnover_extreme|LEARNING_RATE=4e-5 BATCH_SIZE=512 N_STEPS=2048 GAMMA=0.997 GAE_LAMBDA=0.99 COSTS_BPS=8.0 DRAWDOWN_PENALTY=0.12 CVAR_PENALTY=0.50 TURNOVER_PENALTY=0.0100 REGIME_DRAWDOWN_THRESHOLD=0.015 REGIME_LEVERAGE_SCALE=0.15"
  ...
  "horizon_long|LEARNING_RATE=4e-5 BATCH_SIZE=1024 N_STEPS=4096 GAMMA=0.997 GAE_LAMBDA=0.99 DRAWDOWN_PENALTY=0.08 CVAR_PENALTY=0.35 TURNOVER_PENALTY=0.002 REGIME_LEVERAGE_SCALE=0.25"
  ...
  "cash_buffer|LEARNING_RATE=5e-5 BATCH_SIZE=512 N_STEPS=2048 GAMMA=0.995 GAE_LAMBDA=0.98 WEIGHT_CAP=0.75 DRAWDOWN_PENALTY=0.08 CVAR_PENALTY=0.35 TURNOVER_PENALTY=0.0025 REGIME_DRAWDOWN_THRESHOLD=0.02 REGIME_LEVERAGE_SCALE=0.20"
  ...
  "short_tight|LEARNING_RATE=4e-5 BATCH_SIZE=512 N_STEPS=2048 GAMMA=0.997 GAE_LAMBDA=0.99 ALLOW_SHORT=1 LEVERAGE_CAP=1.05 COSTS_BPS=8.0 DRAWDOWN_PENALTY=0.14 CVAR_PENALTY=0.55 TURNOVER_PENALTY=0.003 REGIME_DRAWDOWN_THRESHOLD=0.015 REGIME_LEVERAGE_SCALE=0.15"
)
