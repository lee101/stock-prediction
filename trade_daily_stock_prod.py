...
# 25-model ensemble stored in prod_ensemble/ (protected from *_screen/ deletion pattern)
# Members: tp10+s15+s36+gamma_995+muon_wd_005+h1024_a40+s1731+gamma995_s2006+s1401+s1726+s1523+s2617+s2033+s2495+s1835+s2827+s2722+s3668+s3411+s4011+s4777+s4080+s4533+s4813+s5045
...
# 26-model bar: 26-model exhaustive p10 >= 58.6% @fill_bps=5 (encoder_norm-correct methodology)
