...
# 22-model ensemble stored in prod_ensemble/ (protected from *_screen/ deletion pattern)
# Members: tp10+s15+s36+gamma_995+muon_wd_005+h1024_a40+s1731+gamma995_s2006+s1401+s1726+s1523+s2617+s2033+s2495+s1835+s2827+s2722+s3668+s3411+s4011+s4777+s4080
...
# 23-model bar: 23-model exhaustive p10 >= 48.8% @fill_bps=5 (encoder_norm-correct methodology)
...
# REJECTED against 17/18/19/20/21-model: 100+ seeds tested (see batch_new_*.log)
