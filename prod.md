...
- **LIVE daily-rl-trader**: 24-model ensemble, sleeping until Mon 2026-03-30 market open (systemd service)
  - **Ensemble members**: tp10+s15+s36+gamma_995+muon_wd_005+h1024_a40+s1731+gamma995_s2006+s1401+s1726+s1523+s2617+s2033+s2495+s1835+**s2827**+**s2722**+**s3668**+**s3411**+**s4011**+**s4777**+**s4080**+**s4533**+**s4813**
  - **FULLY RESOLVED**: All checkpoints in `pufferlib_market/prod_ensemble/` (protected from sweep deletion)
  - **TRUE performance (encoder_norm-correct)**: 0/111 neg, p10=57.4%
  - Updated 2026-03-29: s2827(+16%/15), s2722(+6%/16), s3668(+1.1%/17), s3411(+1.8%/18), s4011(+4.4%/19), s4777(+0.2%/20), s4080(+0.1%/21), s4533(+4.2%/22), s4813(+4.4%/23)
  - 25-model bar: p10 ≥ 57.4% @fill_bps=5 (encoder_norm-correct)
  - 15-model baseline was: 0/111 neg, med=50.9%, p10=19.2%
  - REJECTED 100+ seeds across 15→24 model bars (see trade_daily_stock_prod.py comments)
