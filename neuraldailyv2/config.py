"""V2 configuration with temperature annealing and modern transformer settings."""
...
class SimulationConfig:
    """Configuration for unified trading simulation."""
...
class PolicyConfigV2:
    """Model architecture configuration for V2 transformer."""
    ...
    price_offset_pct: float = 0.025  # 2.5% price range
    min_price_gap_pct: float = 0.0005  # 0.05% minimum spread
...
@dataclass
class DailyDatasetConfigV2:
    """Dataset configuration for V2 training."""
...
@dataclass
class DailyTrainingConfigV2:
    """V2 training config with temperature annealing and dual optimizer."""
    ...
    # Temperature annealing (NEW in V2)
    ...
    run_name: str = "neuraldailyv2"
    wandb_project: str = "neuraldailyv2"
    wandb_entity: Optional[str] = None
    log_dir: str = "tensorboard_logs/neuraldailyv2"
    checkpoint_root: str = "neuraldailyv2/checkpoints"
    ...
    dataset: Optional[DailyDatasetConfigV2] = None
    ...
    def get_policy_config(self, input_dim: int) -> PolicyConfigV2:
